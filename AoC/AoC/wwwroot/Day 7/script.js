...
window.module = function () {
    ...
    var getFirstCompletableStep = function (instructions, finishedSteps) {
        var result = '';
    ...
    var getFirstStep = function (instructions, finishedSteps) {
        var result = '';
        ...
        for (var i = 0; i < instructions.length; i++) {
            ...
            if (previousStepFound === false && finishedSteps.indexOf(instruction.previousStep) === -1) {
